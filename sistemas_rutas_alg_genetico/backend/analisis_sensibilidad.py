...
def _formatear_resultado(escenario, nombre, descripcion, parametro_modificado,
    ...
    return {
        ...
        'resultado_nuevo': {
            ...
            'viable':          resultado_nuevo.get('viable', True) if factible_nuevo else False,
            'razon_inviable':  resultado_nuevo.get('razon_inviable') if factible_nuevo else None,
            ...
            'flujos':          resultado_nuevo.get('flujos', {}) if factible_nuevo else {},
            'cuellos_botella': resultado_nuevo.get('cuellos_botella', []) if factible_nuevo else [],
        },
        'impacto': {
            ...
            'mensaje': (
                ...
                if not factible_nuevo else
                'El sistema satisface la demanda pero opera en pérdidas. Inviable económicamente.'
                if not resultado_nuevo.get('viable', True) else
